...
public class IntroducereZborFrame extends JFrame implements PropertyChangeListener{
...
//	}
	...
	public IntroducereZborFrame() {
		...
		spinnerNrLocuri.setModel(new SpinnerNumberModel(0, 0, 10, 1));
		...
		textField.setBounds(433, 124, 200, 25);
		...
		calendarButton.setFont(new Font("Consolas", Font.PLAIN, 15));
		calendarButton.setBounds(683, 125, 140, 25);
